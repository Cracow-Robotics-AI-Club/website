...
const pastEvents = [
  {
    id: 15,
    title: "Cracow Robotics & AI Meetup #15",
    date: "18.05.2026",
    venue: "hub:raum Kraków, Przemysłowa 12",
    description: "Simulations and LLMS!",
    url: "https://luma.com/event/evt-TJursm5r59Zj9as",
  },
  {
    id: 14,
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pastEvents.map((event) => (
            <Link
              ...
              className="group"
            >
              <Card className="bg-card border border-border hover:shadow-lg hover:border-primary/50 transition-all h-full">
